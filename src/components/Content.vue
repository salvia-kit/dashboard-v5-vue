<template>
  <div class="flex flex-col flex-wrap sm:flex-row">
      ...
      >
        ...
        >
          ...
          <p class="mt-4 text-sm leading-5">
            ...
            <span
              class="inline-block font-medium text-gray-500 dark:text-gray-400"
            >
    ...
    <div class="w-full md:w-4/12 md:px-2 mb-6 md:mb-0">
    ...
    <div class="w-full md:w-4/12 md:px-2 mb-6 md:mb-0">
      <div class="shadow-lg rounded-2xl bg-indigo-500 dark:bg-gray-800 p-4">
    ...
    <div class="w-full md:w-4/12 md:px-2 mb-6 md:mb-0">
      <div class="shadow-lg rounded-2xl bg-white dark:bg-gray-800 p-4">
        ...
        <p class="text-black dark:text-white text-3xl font-bold">$99</p>
        <p class="text-gray-500 dark:text-gray-300 text-sm mb-4">
          Per agent per month
        </p>
        <button
          ...
          class="
            ...
            dark:hover-text-gray-900 dark:hover:bg-gray-100
          "
        >
          Request demo
        </button>
        ...
        <ul class="text-sm text-black dark:text-white w-full mt-6 mb-6">
          <li class="mb-3 flex items-center space-x-2">
            ...
            <div>
              All free dashboard
              <a href="#" class="text-red-500 pl-1 font-semibold">
                free plan
              </a>
            </div>
          </li>
